...
echo -e "${GREEN}========================================${NC}"
echo -e "PostgreSQL: postgres://dbnexus:dbnexus_password@localhost:15433/dbnexus_test"
echo -e "MySQL:      mysql://dbnexus:dbnexus_password@localhost:13308/dbnexus_test"
