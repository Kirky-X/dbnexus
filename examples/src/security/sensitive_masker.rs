...
fn main() {
    ...
    let user_records: &[(&str, &str, &str, &str, &str)] = &[
        ("张三", "13812345678", "zhangsan@example.com", "110101199001011234", "北京市朝阳区某某路1号"),
        ("李某某", "13987654321", "li@example.com", "110101198501052345", "上海市浦东新区张江路2号"),
        ("欧阳明月", "13700001111", "ouyang@company.org", "11010120001231234X", "广东省深圳市南山区科苑路3号"),
    ];

    println!("  {:<8} {:<14} {:<24} {:<20} {:<24}", "姓名", "手机号", "邮箱", "身份证", "地址");
    println!("  {}", "-".repeat(94));
